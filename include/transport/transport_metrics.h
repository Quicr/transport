...
namespace qtransport {
    ...
    struct MetricsConnSample {
        ...
        MetricsConnSample(const TimeStampUs sample_time, const uint64_t conn_id, const UdpConnectionMetrics udp_sample)
            : sample_time(sample_time), conn_ctx_id(conn_id), udp_sample(udp_sample) {}
        ...
        MetricsConnSample(const TimeStampUs sample_time, const uint64_t conn_id,
                          const QuicConnectionMetrics quic_sample)
            : sample_time(sample_time), conn_ctx_id(conn_id), quic_sample(quic_sample) {}
    };
    ...
    struct MetricsDataSample {
        ...
        MetricsDataSample(const TimeStampUs sample_time, const uint64_t conn_id, const uint64_t data_id,
            ...
            : sample_time(sample_time), conn_ctx_id(conn_id), data_ctx_id(data_id), udp_sample(udp_sample) {}
        ...
        MetricsDataSample(const TimeStampUs sample_time, const uint64_t conn_id, const uint64_t data_id,
            ...
            : sample_time(sample_time), conn_ctx_id(conn_id), data_ctx_id(data_id), quic_sample(quic_sample) {}
    };
