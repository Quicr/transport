...
namespace qtransport {
    ...
    struct MinMaxAvg
    {
        ...
        {
            return min == other.min && max == other.max && avg == other.avg && _value_sum == other._value_sum;
        }
    ...
    struct QuicConnectionMetrics
    {
        ...
        constexpr bool operator==(const QuicConnectionMetrics& other) const
        {
            return this->cwin_congested == other.cwin_congested &&
                   this->_prev_cwin_congested == other._prev_cwin_congested &&
                   this->tx_congested == other.tx_congested && this->tx_rate_bps == other.tx_rate_bps &&
                   this->rx_rate_bps == other.rx_rate_bps && this->tx_cwin_bytes == other.tx_cwin_bytes &&
    ...
    struct QuicDataContextMetrics
    {
        ...
        constexpr bool operator==(const QuicDataContextMetrics& other) const
        {
            return this->enqueued_objs == other.enqueued_objs && this->rx_stream_cb == other.rx_stream_cb &&
                   ...
                   this->_prev_tx_delayed_callback == other._prev_tx_delayed_callback &&
    ...
    struct MetricsConnSample
    {
        ...
        MetricsConnSample(const time_stamp_us sample_time,
    ...
    struct MetricsDataSample
    {
        ...
        MetricsDataSample(const time_stamp_us sample_time,
                          const uint64_t conn_id,
